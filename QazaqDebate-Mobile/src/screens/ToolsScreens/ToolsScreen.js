  ...
  return (
    <View style={styles.container}>
      <View style={styles.profileView}>
        <Avatar.Image size={40} source={{uri: 'https://picsum.photos/200/300'}} style={{marginRight:15, marginLeft: 10}} />
        <View>
        ...
        <Icon name="chevron-forward-sharp" size={25} color={"#c8c8c8"} style={styles.profileIcon} />
      </View>
      ...
      <View style={styles.footerView}>
        ...
        <View style={styles.profileView}>
          ...
          <View style={{ flexWrap: 'wrap', width: '80%' }}>
            <Text style={styles.name}>
              Роль аналитика в дебатах
            </Text>
            <Text style={styles.description}>Для хорошего анализа нужно много практики</Text>
          </View>
          <Icon name="chevron-forward-sharp" size={25} color={"#c8c8c8"} style={styles.profileIcon} />
        </View>
